        ...
        <div className="fixed bottom-0   bg-white h-[calc(100vh-65px)] w-full px-8 ">
          <ul className="flex flex-col items-center mt-28 text-mainColor  text-center gap-4">
            <li
              ...
              className={`${
                path.pathname === "/"
                  ? "border border-mainColor/20 bg-mainColor/15"
                  : ""
          ...
          <button
            className="mt-8 bg-mainColor text-white font-medium w-full py-3 rounded-md  hover:bg-mainColor/80 duration-300 transition-all"
            onClick={() => {
