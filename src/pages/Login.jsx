    ...
    <div className="w-screen min-h-screen flex items-center justify-center">
      <div className="bg-white mt-[80px] px-4 py-8 rounded-lg sm:min-w-[500px] w-full sm:w-fit mx-4 text-mainColor mb-4">
        <h1 className="text-2xl font-bold mb-4 text-mainColor/95">
          Login to <span className="text-mainColor">Account</span>
        </h1>
        ...
        <p className="text-mainColor/60 mt-8 text-sm">Doesn't have an acccount? <span onClick={()=> navigate('/create-account')} className="text-mainColor hover:underline transition-all ease-linear duration-300 cursor-pointer">Click here</span></p>
      </div>
    </div>
  );
};
